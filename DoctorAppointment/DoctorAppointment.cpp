    ...
    switch (login) {
        ...
        back:
            ...
            switch (choice) {
                case 1: {
                    cout
                            << "----------------------Please Enter Patients Info and his username and password ---------------------- \n";
                    int userId, choice2;
                    ...
                    Patient p(userId, userFirstName, userLastName, userAddress, Username, userPassword,
                              DateOfHisReservation);
                    ...
                    switch (choice2) {
                        case 1: {
                            ...
                            cin >> medicineDescription;
                            cout << "enter Medicine Price: ";
                            cin >> price;
                            cout << "enter Medicine Taken Times Per Day: ";
                            cin >> timesPerDay;
                ...
                case 3: {
                    ...
                    if (searchedPatient.getId() != 0) {
                        ...
                        if (choice4 == 1) {
                            ...
                            int day, month, year;
                            cout << "enter day of reservation: ";
                            cin >> day;
                            cout << "enter month of reservation: ";
                            cin >> month;
                            cout << "enter year of reservation: ";
                            cin >> year;
